...
exports.WorkplacesService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
const pagination_1 = require("../shared/pagination");
let WorkplacesService = class WorkplacesService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
...
exports.WorkplacesService = WorkplacesService;
exports.WorkplacesService = WorkplacesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], WorkplacesService);
//# sourceMappingURL=workplaces.service.js.map